...
- **NEVER create a new MCP server** if an existing OSS one already solves the problem — prefer community servers (e.g., `@getscaleforge/mcp-meta-ads` already installed for Meta Ads).
