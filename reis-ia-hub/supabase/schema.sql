...
create table public.profiles (
  ...
  email text not null,
  avatar_url text,
  role text not null default 'starter' check (role in ('admin', 'mentoria', 'builder', 'journey', 'starter')),
  company text,
  phone text,
...
create table public.tasks (
  ...
  category text not null default 'general' check (category in ('systems', 'marketing', 'builders', 'general')),
