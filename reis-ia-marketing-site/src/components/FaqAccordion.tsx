  ...
  return (
    <svg
      ...
      style={{
        ...
        color: isOpen ? '#4A90FF' : 'rgba(255,255,255,0.50)',
      }}
    >
      ...
      {items.map((item, index) => {
        ...
        return (
          <div key={index} style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            <button
              className="w-full text-left flex items-center justify-between gap-4 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(74,144,255,0.5)]"
              style={{
                padding: '24px 0',
